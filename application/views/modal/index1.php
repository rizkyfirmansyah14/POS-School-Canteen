...
endforeach;
  ...
  ?>
							<tr>
								...
								<td>:</td>
								<form action="<?php echo site_url('sistem/simpan1')?>" method="POST" enctype="multipart/form-data">
  ...
  border-bottom: 2px solid red;" name="tot_har" type="number" readonly value="<?php echo $tot ?>">
					...
					<h5>Mukan Nomor Meja</h5>
					<input style="  width: 27%;
  padding: 12px 20px;
  margin: 8px 0;
  box-sizing: border-box;
  border: none;
  border-bottom: 2px solid red;" type="number" id="fname" name="meja">
				</div>
